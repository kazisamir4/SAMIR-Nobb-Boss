...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰samir")
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : FOURKAN UDDIN TANVIR  
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : Termux command 2022 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : kazisamir4
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 01817313151
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX: samir): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [samir_OLD] : %s/%s -> \033[0;92m [ samir-OK:%s ]- \033[0;91m[samir-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
